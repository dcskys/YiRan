...
import com.dc.androidtool.DouBanMovie.listfragment.recycleview.MovieRecyclerAdapter;
...
public class SearchFragmentMovie extends Fragment {
    ...
    private void inintView(View view) {
        ...
        recyclerView = (RecyclerView) view.findViewById(R.id.fragment_search_movie_recycler);
    ...
    private void loadData(final int page) {
        ...
        StringRequest stringRequest = new StringRequest
                (Request.Method.GET, movieUrl+page, new Response.Listener<String>() {
                    @Override
